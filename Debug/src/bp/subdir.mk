...
src/bp/%.o src/bp/%.su src/bp/%.cyclo: ../src/bp/%.c src/bp/subdir.mk
...
clean: clean-src-2f-bp

clean-src-2f-bp:
	-$(RM) ./src/bp/bp.cyclo ./src/bp/bp.d ./src/bp/bp.o ./src/bp/bp.su

.PHONY: clean-src-2f-bp
